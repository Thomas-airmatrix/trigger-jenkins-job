...
function poll_build(url) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        for (let i = 0; i < 20; i++) {
            ...
            core.info(`Job starting: ${((_a = job.data) === null || _a === void 0 ? void 0 : _a.why) || "Job Spawning"}`);
            if (job.data.blocked) {
                throw "Request Blocked";
            }
            let build = (_c = (_b = job === null || job === void 0 ? void 0 : job.data) === null || _b === void 0 ? void 0 : _b.executable) === null || _c === void 0 ? void 0 : _c.number;
            if (build != null) {
                return build;
            }
        }
...
function build_info(build_number) {
    return __awaiter(this, void 0, void 0, function* () {
        let job = yield axios({
            method: 'get',
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let job_id = yield poll_build(x.headers['location']);
            let est = 5000;
            for (let i = 0; i < 1000; i++) {
                yield sleep(est);
                let info = yield build_info(job_id);
                if (info.inProgress) {
                    continue;
                }
